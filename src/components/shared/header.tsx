...
export function Header({ points, user }: HeaderProps) {
  ...
  return (
    <header
      className={`fixed left-1/2 right-auto top-4 z-50 mx-auto transition-all duration-300 ease-in-out ${isScrolled ? "w-[calc(60%-2rem)]" : "w-[calc(100%-2rem)]"} max-w-7xl -translate-x-1/2 rounded-full bg-background/60 backdrop-blur-sm`}
    >
      <div className="container grid animate-fade-in-up-delay-8 grid-cols-3 items-center px-4 py-2">
        ...
        <div className="flex items-center justify-center ">
          ...
          >
            ...
            <span className="mr-2 whitespace-nowrap font-serif text-xl font-light">
