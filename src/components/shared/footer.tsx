...
export default function Footer() {
  return (
    <div className="p-8 md:p-12 lg:p-16">
      <footer className="rounded-3xl bg-muted/80 p-8 backdrop-blur-sm md:p-12">
          ...
          <div className="grid items-center gap-8 lg:grid-cols-2">
            <div className="space-y-6">
              <h1 className="text-4xl font-light md:text-5xl lg:text-6xl">
                Let&apos;s <span className="font-normal">preserve</span> our{" "}
                <span className="block">
                  <span className="font-normal">heritage</span> together
                </span>
              </h1>
              <Button
                variant="secondary"
                className="h-12 rounded-full bg-muted px-6 hover:bg-accent"
              >
                GET IN TOUCH
            ...
            <div className="space-y-2 text-right text-muted-foreground">
              <p>Email: contact@sbibaheritage.org</p>
              <p>Phone: +216 XX XXX XXX</p>
              <p>Address: Sbiba Archaeological Site,</p>
              <p>Kasserine, Tunisia</p>
            </div>
          </div>

          {/* Footer Navigation */}
          <div className="flex flex-col items-start justify-between border-t border-border/40 pt-8 md:flex-row md:items-center">
